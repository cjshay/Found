...
User.create(username: "prophetroyal", password: "prophetroyal")
...
users_pictures.length.times do |i|
  ...
  user.update(image: File.open("app/assets/images/user_#{num}.png"))
end
4.times do
...
(stories_pictures.length - 3).times do |i|
  ...
  story.update(image: File.open("app/assets/images/story_#{num}.png"))
end
